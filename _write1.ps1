...
$base = "e:\mediamix-kmp\shared\src\commonMain\kotlin\com\mediamix\shared"

# Create spider directory
New-Item -ItemType Directory -Force -Path "$base\spider" | Out-Null
New-Item -ItemType Directory -Force -Path "e:\mediamix-kmp\shared\src\commonTest\kotlin\com\mediamix\shared\spider" | Out-Null
...
"@
[System.IO.File]::WriteAllText("$base\spider\SpiderAdapter.kt", $content, $utf8)
Write-Host "OK: SpiderAdapter.kt"
